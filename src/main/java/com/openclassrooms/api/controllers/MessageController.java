...
import com.openclassrooms.api.dto.MessageResponse;
...
public class MessageController {
    ...
    public ResponseEntity<MessageResponse> createMessage(@RequestBody MessageDTO messageDTO) {
        if (messageDTO.getRentalId() == null || messageDTO.getUserId() == null || 
            ...
            throw new RuntimeException("Missing required fields: rental_id, user_id, and message are required.");
        }
        ...
        try {
            ...
            // Créer la réponse au format attendu par Angular
            MessageResponse response = new MessageResponse(createdMessage.getMessage());
